...
public final class GoogleAuthHelper {
   ...
   */
  private static final String CALLBACK_URI = "http://lunchandmeet.me/index.jsp";
  ...
  public User deserializeUser(JSONObject userJson) throws JSONException, MalformedURLException {
    ...
    if (userJson.has("link"))  user.profileURL = (String) userJson.get("link");
    String pictureUrl = (userJson.has("picture") && userJson.get("picture") != null) ? ((String) userJson.get("picture")) + "?sz=100" : "/img/no-picture.jpg";
